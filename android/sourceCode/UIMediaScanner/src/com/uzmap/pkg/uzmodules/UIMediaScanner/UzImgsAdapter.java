...
public class UzImgsAdapter extends BaseAdapter {
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if ((arg0 != this.index) && (arg0 > this.index)) {
			...
			holder = (Holder) ((View) this.mHolderlist.get(arg0 % index )).getTag();
		...
		if (holder.itemIv != null) {
			...
			if (((SoftReference<Bitmap>) this.cacheMap.get(((FileInfo) this.mAllImgFiles.get(arg0)).path)).get() == null)
				this.mUtil.imgExcute(holder.itemIv, new ImgCallBackLisner(arg0), new FileInfo[] { (FileInfo) this.mAllImgFiles.get(arg0) });
			else {
				holder.itemIv.setImageBitmap((Bitmap) ((SoftReference<Bitmap>) this.cacheMap.get(((FileInfo) this.mAllImgFiles.get(arg0)).path)).get());
			}
		}
